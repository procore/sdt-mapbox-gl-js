...
function addVertex(array, anchorX, anchorY, ox, oy, tx, ty, sizeVertex, pixelOffsetX, pixelOffsetY, minFontScaleX, minFontScaleY) {
    array.emplaceBack(
        // a_pos_offset
        anchorX,
        anchorY,
...
class SymbolBucket implements Bucket {
    ...
    addSymbols(arrays: SymbolBuffers,
        ...
        const addSymbol = (symbol: SymbolQuad) => {
            ...
            addVertex(layoutVertexArray, labelAnchor.x, labelAnchor.y, tl.x, y + tl.y, tex.x, tex.y, sizeVertex, pixelOffsetTL.x, pixelOffsetTL.y, mfsx, mfsy);
            addVertex(layoutVertexArray, labelAnchor.x, labelAnchor.y, tr.x, y + tr.y, tex.x + tex.w, tex.y, sizeVertex, pixelOffsetBR.x, pixelOffsetTL.y, mfsx, mfsy);
            addVertex(layoutVertexArray, labelAnchor.x, labelAnchor.y, bl.x, y + bl.y, tex.x, tex.y + tex.h, sizeVertex, pixelOffsetTL.x, pixelOffsetBR.y, mfsx, mfsy);
            addVertex(layoutVertexArray, labelAnchor.x, labelAnchor.y, br.x, y + br.y, tex.x + tex.w, tex.y + tex.h, sizeVertex, pixelOffsetBR.x, pixelOffsetBR.y, mfsx, mfsy);
